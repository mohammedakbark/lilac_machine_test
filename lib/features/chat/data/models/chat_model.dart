...
//       Data(type: json["type"], id: json["id"]);
...
//   Included({required this.type, required this.id, required this.attributes});
...
class MessageModel {
  ...
  factory MessageModel.fromJson(Map<String, dynamic> json) {
    return MessageModel(
      ...
      message: json['message'],
      isOneTimeView: json['is_one_time_view'],
      isReadReceiptsOn: json['is_read_receipts_on'],
      isOnVanishMode: json['is_on_vanish_mode'],
      sentAt: DateTime.parse(json['sent_at']),
      createdAt: DateTime.parse(json['created_at']),
      updatedAt: DateTime.parse(json['updated_at']),
...
class SenderModel {
  ...
  final String square100PhotoUrl;
  final String square300PhotoUrl;
  final String square500PhotoUrl;
  ...
  SenderModel({
    ...
    required this.email,
    required this.profilePhotoUrl,
    required this.square100PhotoUrl,
    required this.square300PhotoUrl,
    required this.square500PhotoUrl,
  });
  ...
  factory SenderModel.fromJson(Map<String, dynamic> json) {
    return SenderModel(
      ...
      email: json['email'],
      profilePhotoUrl: json['profile_photo_url'],
      square100PhotoUrl: json['square100_profile_photo_url'],
      square300PhotoUrl: json['square300_profile_photo_url'],
      square500PhotoUrl: json['square500_profile_photo_url'],
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'email': email,
      'profile_photo_url': profilePhotoUrl,
      'square100_profile_photo_url': square100PhotoUrl,
      'square300_profile_photo_url': square300PhotoUrl,
      'square500_profile_photo_url': square500PhotoUrl,
    };
  }
}
